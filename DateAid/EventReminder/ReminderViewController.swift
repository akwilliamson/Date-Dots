...
class ReminderViewController: UIViewController {
    ...
    private lazy var baseView: ReminderView = {
    ...
    init(reminderDetails: ReminderDetails, notificationRequest: UNNotificationRequest?, delegate: ReminderDelegate) {
        self.viewModel = ReminderViewModel(reminderDetails: reminderDetails, notificationRequest: notificationRequest)
